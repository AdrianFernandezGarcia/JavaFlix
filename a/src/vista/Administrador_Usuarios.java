...
public class Administrador_Usuarios extends javax.swing.JFrame {
    ...
    private void botonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBorrarActionPerformed
        ...
        if(GestionClientes.clientes.size()==1){
            Cliente cliente =GestionClientes.clientes.get(jList1.getSelectedIndex());
            cliente=null;
            GestionClientes.clientes.remove(jList1.getSelectedIndex());
            GestionClientes.clientes.add(jList1.getSelectedIndex(), cliente);
